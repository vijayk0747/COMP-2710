...
* project2_krishnamoorthy_vzk0023.cpp

* compile using g++ -o proj2 project2_krishnamoorthy_vzk0023.cpp
* run using ./proj2

* Learned how to use boolean values properly from Dr.Li
* Created all of the prototypes and testers using Dr.Li's Project 2 Hints
